...
func TestTemplateBindingPreservesValuesAndOperationStructure(t *testing.T) {
	for _, tc := range []struct {
		...
		{"query_search", `{"body":{"query":{"terms":{"term":{"index":"a","id":"b","path":"c"}}}}}`, "/body/query/terms/term/index", "string", `"other"`, true},
		{"query_search", `{"body":{"query":{"bool":{"filter":[{"range":{"term":{"gte":0}}}]}}}}`, "/body/query/bool/filter/0/range/term/gte", "integer", `7`, false},
		{"query_search", `{"body":{"query":{"bool":{"must":{"terms":{"match":{"index":"a","id":"b","path":"c"}}}}}}}`, "/body/query/bool/must/terms/match/index", "string", `"other"`, true},
