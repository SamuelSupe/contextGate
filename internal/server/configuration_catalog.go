...
type configurationSource struct {
	...
	Version         string            `json:"version,omitempty" jsonschema:"Required for InfluxDB: 1, 2 or 3."`
...
func (s *Server) configurationMCP(agent model.ConfigurationAgent) *mcp.Server {
	...
	configurationTool(s, server, agent, "list_supported_databases", "List individually verified database products, native query families, read-only protection, limitations and query examples.", true, func(_ context.Context, _ struct{}) (any, error) {
