...
The examples below use **0.5.0**; update the version for subsequent releases. New artifacts and launchers use `contextgate`; an additional `mcpdbhub` launcher preserves existing scripts.
